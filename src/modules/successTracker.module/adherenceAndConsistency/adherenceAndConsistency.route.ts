...
export const optionValidationChecking = <T extends keyof IAdherenceAndConsistency | 'sortBy' | 'page' | 'limit' | 'populate'>(
  filters: T[]
) => {
  return filters;
};
...
const controller = new AdherenceAndConsistencyController();
...
export const AdherenceAndConsistencyRoute = router;

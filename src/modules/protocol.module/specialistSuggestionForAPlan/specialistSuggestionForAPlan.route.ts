...
export const optionValidationChecking = <T extends keyof ISpecialistSuggestionForAPlan | 'sortBy' | 'page' | 'limit' | 'populate'>(
  filters: T[]
) => {
  return filters;
};
...
const controller = new SpecialistSuggestionForAPlanController();
...
export const SpecialistSuggestionForAPlanRoute = router;

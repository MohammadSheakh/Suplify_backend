...
HealthAndPerformanceSchema.set('toJSON', {
  transform: function (doc, ret, options) {
    ret._HealthAndPerformanceId = ret._id; // Rename _id to _subscriptionId
    delete ret._id; // Remove the original _id field
    return ret;
  },
});

export const HealthAndPerformance = model<
  IHealthAndPerformance,
  IHealthAndPerformanceModel
>('HealthAndPerformance', HealthAndPerformanceSchema);
